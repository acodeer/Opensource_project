...
* **팀 프로젝트 미숙:** 초기 계획 설정의 미흡함을 핵심 기능 선의 정의와 역할 분담 시스템 구축으로 해결


* **크로스 플랫폼 호환성:** 웹 환경 개발 후 모바일 이식 과정에서 발생한 API 호환 문제를 OS 버전 명시와 최적화로 극복



2) 한계점 및 개선 계획 

* **신뢰 시스템:** 사용자 매너 점수 및 신뢰도 검증 시스템을 도입하여 '야구 온도' 기능을 강화할 예정


* **비즈니스 확장:** 구장 인근 상권(맛집, 주차) 연계 및 간편 티켓 예매 등 O2O 모델 확장을 고려 중


* **알림 고도화:** 매칭 성공이나 댓글 등록 등에 대한 실시간 푸시 알림 시스템을 도입할 계획
...
* **산업적 측면:** 1인 관중의 진입 장벽을 낮춰 전체 관중 수 증대 및 신규 팬덤 유입 가속화에 기여.


* **지역 상권 상생:** 소상공인과 파티원을 연결하는 타겟 마케팅 플랫폼으로 확장하여 지역 경제 활성화를 도모


* **사회적 가치:** 암표 거래 방지 안내 및 매너 평가를 통해 건전한 응원 문화와 신뢰도 높은 팬 커뮤니티를 형성
