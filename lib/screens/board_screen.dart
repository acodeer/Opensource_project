...
class _BoardScreenState extends State<BoardScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children:
        _categories.map((category) => _buildPostList(category)).toList(),
      ),
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final posts = snapshot.data!.docs.where((doc) {
          ...
          data.containsKey('category') ? data['category'] : '자유';
  ...
  void _showWriteDialog(BuildContext context, String category) {
    ...
    final youtubeCtrl = TextEditingController(); // 🔹 유튜브 링크 입력용
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  labelStyle: TextStyle(color: Colors.grey),
                  hintText: '예: https://youtu.be/xxxx 또는 https://www.youtube.com/watch?v=xxxx',
                  hintStyle: TextStyle(color: Colors.grey, fontSize: 12),
                  enabledBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color: Colors.grey),
                  ),
